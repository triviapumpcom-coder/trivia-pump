    ...
    <div className="rounded-xl bg-black/40 border border-white/10 p-2">
      <div className="flex items-center justify-between mb-1">
        <div className="flex items-center gap-2">
          ...
          <img src="/logo-quiz.png" alt="Quiz Pump" className="w-6 h-6" />
          <h1 className="text-sm font-bold text-white">Quiz Pump Stream</h1>
        </div>
        
            <div className="flex items-center gap-2">
              <SoundToggle />
              <a
                href="https://x.com/QuizPumpcom"
                target="_blank"
